...
public class IOHandler {
	...
	// Outputs
	private final static GpioPinDigitalOutput ladeBoxen_MotorL_Pin = gpio
			.provisionDigitalOutputPin(RaspiPin.GPIO_00, "ladeBoxen_MotorL",
					PinState.HIGH);
	private final static GpioPinDigitalOutput ladeBoxen_MotorR_Pin = gpio
			.provisionDigitalOutputPin(RaspiPin.GPIO_02, "ladeBoxen_MotorR",
					PinState.HIGH);
	private final static GpioPinDigitalOutput ball_Motor_Pin = gpio
			.provisionDigitalOutputPin(RaspiPin.GPIO_24, "ball_Motor",
					PinState.HIGH);
	...
	public static boolean[] ladeBoxen_Sensoren = new boolean[] { false, false,
			false };
	...
	public static void init(boolean debug) throws IOException {
		// I2C
		final ADS1115GpioProvider AnalogGpioProvider = new ADS1115GpioProvider(
				I2CBus.BUS_1, ADS1115GpioProvider.ADS1115_ADDRESS_0x48);
		GpioPinAnalogInput AnalogInputs[] = {
				gpio.provisionAnalogInputPin(AnalogGpioProvider,
						ADS1115Pin.INPUT_A0, "Spieler1_JoystickL"),
				gpio.provisionAnalogInputPin(AnalogGpioProvider,
						ADS1115Pin.INPUT_A1, "Spieler1_JoystickR"),
				gpio.provisionAnalogInputPin(AnalogGpioProvider,
						ADS1115Pin.INPUT_A2, "Spieler2_JoystickL"),
				gpio.provisionAnalogInputPin(AnalogGpioProvider,
						ADS1115Pin.INPUT_A3, "Spieler2_JoystickR"), };
		AnalogGpioProvider.setProgrammableGainAmplifier(
				ProgrammableGainAmplifierValue.PGA_4_096V, ADS1115Pin.ALL);
		...
		AnalogInputs[0].addListener(new GpioPinListenerAnalog() {
			...
			public void handleGpioPinAnalogValueChangeEvent(
				...
				if (event.getValue() > 0.0) {
					int value = (int) Math.round(((event.getValue() * 4.096) / ADS1115GpioProvider.ADS1115_RANGE_MAX_VALUE) / 3.4 * joystickAmplitude) - (joystickAmplitude / 2);
		...
		// spieler1_NeuerBall
		final GpioPinDigitalInput spieler1_NeuerBall = gpio
				.provisionDigitalInputPin(RaspiPin.GPIO_26,
		...
		// spieler2_NeuerBall
		final GpioPinDigitalInput spieler2_NeuerBall = gpio
				.provisionDigitalInputPin(RaspiPin.GPIO_23,
						PinPullResistance.PULL_DOWN);
		...
		// spieler1_Tor
		final GpioPinDigitalInput spieler1_Tor = gpio.provisionDigitalInputPin(
				RaspiPin.GPIO_21, PinPullResistance.PULL_DOWN);
		...
		// spieler2_Tor
		final GpioPinDigitalInput spieler2_Tor = gpio.provisionDigitalInputPin(
				RaspiPin.GPIO_22, PinPullResistance.PULL_DOWN);
...

		{
			...
			ladeBoxen_Sensoren[0] = gpio.provisionDigitalInputPin(
			...
			ladeBoxen_Sensoren[1] = gpio.provisionDigitalInputPin(
					RaspiPin.GPIO_28, PinPullResistance.PULL_DOWN);
			...
			ladeBoxen_Sensoren[2] = gpio.provisionDigitalInputPin(
					RaspiPin.GPIO_29, PinPullResistance.PULL_DOWN);
...

		{
			...
			ladeBoxen_Positionsschalter[0] = gpio.provisionDigitalInputPin(
					RaspiPin.GPIO_12, PinPullResistance.PULL_DOWN);
			ladeBoxen_Positionsschalter[0]
			...
			ladeBoxen_Positionsschalter[1] = gpio.provisionDigitalInputPin(
					RaspiPin.GPIO_13, PinPullResistance.PULL_DOWN);
			ladeBoxen_Positionsschalter[1]
					.addListener(new GpioPinListenerDigital() {
						@Override
						public void handleGpioPinDigitalStateChangeEvent(
								GpioPinDigitalStateChangeEvent event) {
			...
			ladeBoxen_Positionsschalter[2] = gpio.provisionDigitalInputPin(
					RaspiPin.GPIO_14, PinPullResistance.PULL_DOWN);
			ladeBoxen_Positionsschalter[2]
					.addListener(new GpioPinListenerDigital() {
						@Override
						public void handleGpioPinDigitalStateChangeEvent(
								GpioPinDigitalStateChangeEvent event) {
			...
			ladeBoxen_Positionsschalter[3] = gpio.provisionDigitalInputPin(
					RaspiPin.GPIO_03, PinPullResistance.PULL_DOWN);
			ladeBoxen_Positionsschalter[3]
					.addListener(new GpioPinListenerDigital() {
						@Override
						public void handleGpioPinDigitalStateChangeEvent(
								GpioPinDigitalStateChangeEvent event) {
		...
		final GpioPinDigitalInput ball_BallEingeworfen = gpio
				.provisionDigitalInputPin(RaspiPin.GPIO_25,
						PinPullResistance.PULL_DOWN);
	...
	public static void setLadeBoxSollPosition(LagerPosition newPosition) {
		...
		if (newPosition != ladeBoxen_MomentanePosition
				&& newPosition != LagerPosition.UNKNOWN) {
			if (ladeBoxen_MomentanePosition != LagerPosition.UNKNOWN)
				if (ladeBoxen_SollPosition.ordinal() < ladeBoxen_MomentanePosition
						.ordinal()) {
					// To the Left
					ladeBoxen_MotorL_Pin.high();
			...
			if (ladeBoxen_SollPosition.ordinal() < ladeBoxen_LastPosition
					.ordinal()) {
				// To the Left
				ladeBoxen_MotorL_Pin.high();
				ladeBoxen_MotorR_Pin.low();
