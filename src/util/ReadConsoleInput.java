...
public class ReadConsoleInput {
     ...
     * und liefert die Zahl zur�ck. Wird etwas anderes als eine ganze Zahl
     * eingegeben, so liefert die Methode die kleinstm�gliche darstellbare ganze
     * Zahl.
     * 
     * @param printError
     *            Gibt an, ob ein Error in der Konsole ausgegeben wird.
     ...
     * Konsole ein und liefert diese Zahl zur�ck. Wird etwas anderes als eine
     ...
     * und liefert true zur�ck wenn der eingegebene String "y" oder "Y" ist.
     * Wird etwas anderes eingegeben wird false zur�ckgegeben.
     * Bei einem Fehler wird false zur�ckgegeben.
     * 
     * @param printError
     *            Gibt an, ob ein Error in der Konsole ausgegeben wird.
